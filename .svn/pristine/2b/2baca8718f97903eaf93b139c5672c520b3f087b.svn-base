...
export default {
  'navbar.lang': 'English',
  'menu.demo': '模拟例子',
  'menu.demo.searchtable': '表格例子',
  'menu.flowPool':'流量池看板',
  'menu.flowPool.decisionData':'流量池决策数据',
  'menu.financialDecision':'财务决策数据',
  'menu.financialDecision.packageCostBenefit':'套餐成本收益',
  'menu.operational': '运营决策数据',
  'menu.operational.card': '单卡贡献值',
  'menu.user.list': '用户列表',
  'menu.user.portrait': '用户画像',
